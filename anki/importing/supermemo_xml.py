...
class SupermemoXmlImporter(NoteImporter):
    ...
    def __init__(self, *args):
        ...
        self.META.pathsToBeTagged = ['English for begginers', 'Advanced English 97',
                                     'Phrasal Verbs']  # path patterns to be tagged - in gui entered like 'Advanced English 97|My Vocablary'
